...
[![CI](https://github.com/gradeloop/gradeloop-core-v2/actions/workflows/ci.yml/badge.svg)](https://github.com/gradeloop/gradeloop-core-v2/actions)
...
Quick links
- Local development & setup: `docs/local-dev-guide.md`
- Documentation index: `docs/README.md`
- Contribution & PR guidelines: `CONTRIBUTING.md`
- Service communication patterns (gRPC/REST/events): `docs/service-communication.md`
- Observability, metrics, logs, and tracing: `docs/observability.md`
- Architecture Decision Records (ADRs): `docs/adr/README.md` (individual ADRs under `docs/adr/`)
- API docs placeholder: `docs/api/` (service-level API docs live here as they are added)
- Per-service READMEs: `apps/services/<service-name>/README.md`
- Infrastructure and local compose: `infra/compose/docker-compose.yml`
- Dev scripts: `scripts/`
...
Where to run things
- Local full-stack: See `infra/compose/docker-compose.yml` and `docs/local-dev-guide.md`.
