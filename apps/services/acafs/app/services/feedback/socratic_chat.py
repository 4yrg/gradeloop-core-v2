"""Socratic chat service using OpenRouter / MiniMax M2.5.
...
class SocraticChatService:
    """Handles Socratic tutoring turns via OpenRouter / MiniMax M2.5."""
    ...
    async def get_hint(
        ...
        *,
        ...
        # MiniMax M2.5 does not support the `reasoning` param — do not send it.
        _reasoning_models = ("claude-3-7", "o1", "o3", "deepseek-r1", "gemini-2.5", "gemma-4")
