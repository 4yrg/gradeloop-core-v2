...
} from "@/components/instructor/test-case-block";
...
export default function CreateAssignmentPage() {
  ...
  const editorTheme = (systemTheme === "dark" ? "dark" : "light") as
    | "dark"
    | "light";
  ...
  // ── Local UI state ─────────────────────────────────────────────────────────
  const [expandedCriterionId, setExpandedCriterionId] = React.useState<
    string | null
  >(criteria[0]?.id ?? null);
  const [expandedTestCaseId, setExpandedTestCaseId] = React.useState<
    number | null
  >(null);
  ...
  const addTestCase = () => {
    const nextId =
      testCases.length > 0
        ? Math.max(...testCases.map((t) => t.test_case_id)) + 1
        : 1;
    const next: TestCase = {
      test_case_id: nextId,
      description: "",
      ...
      <div className="flex-1 space-y-4">
            ...
            <div className="bg-card border border-border/60 rounded-xl p-6 space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground -mt-1">
                  Visible to students. Explain the purpose, expectations, and
                  requirements.
                </p>
                <Textarea
                  id="description"
              ...
              <div className="space-y-2 pt-5 border-t border-border/40">
                ...
                <p className="text-xs text-muted-foreground -mt-1">
                  Used by the AI evaluation engine to understand learning
                  outcomes.{" "}
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    updateAssignment({ objective: e.target.value })
                  }
                />
              </div>
            </div>
          ...
          <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
            ...
            <div className="bg-card border border-border/60 rounded-xl p-6 space-y-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Sets the default language for submissions and the sample
                  answer editor.
                </p>
              </div>
              <LanguageSelector
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSettings({ release_date: e.target.value })
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSettings({ due_date: e.target.value })
                    }
                  />
                </div>
              </div>
            ...
            <div className="bg-card border border-border/60 rounded-xl p-6 space-y-3">
              ...
              >
                <label className="flex items-center justify-between cursor-pointer">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      updateSettings({ allow_late_submission: v })
                    }
                  />
                </label>
                {settings.allow_late_submission && (
                  <div className="space-y-2 pt-3 border-t border-border/40">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSettings({ late_due_date: e.target.value })
                      }
                    />
                  </div>
                )}
              ...
              >
                <label className="flex items-center justify-between cursor-pointer">
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground mt-0.5">
                      Restrict to a fixed duration after the student opens the
                      assignment
                    </div>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={(v) =>
                      updateSettings({ time_limit_enabled: v })
                    }
                  />
                </label>
                {settings.time_limit_enabled && (
              ...
              <label className="flex items-center justify-between p-4 rounded-xl border border-border/60 cursor-pointer hover:border-border transition-colors">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) =>
                    updateSettings({ group_submission: v })
                  }
                />
              </label>
              ...
              <label className="flex items-center justify-between p-4 rounded-xl border border-border/60 cursor-pointer hover:border-border transition-colors">
                ...
                <Switch
                  ...
                  onCheckedChange={(v) =>
                    updateSettings({ multiple_submissions: v })
                  }
                />
              </label>
            </div>
          ...
          <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-lg">
                    ...
                    <div className="space-y-4 text-sm text-muted-foreground">
                      <p>
                        A well-written rubric gives the AI grading engine clear,
                        objective expectations for each level of performance.
                      </p>
                      <ul className="space-y-2 list-disc list-inside">
                        ...
                        <li>
                          ...
                          against your descriptions. Best for qualitative
                          criteria like code quality or design.
                        </li>
                        <li>
                          <strong>LLM + AST mode</strong> enriches LLM
                          evaluation with structural code analysis — ideal for
                          correctness and complexity criteria.
                        </li>
                        <li>
                          <strong>Deterministic mode</strong> relies entirely on
                          test case output matching. Use for exact-output
                          problems.
                        </li>
                        <li>
            ...
            {!weightValid && criteria.length > 0 && (
              <p className="text-xs text-red-500 flex items-center gap-1.5">
                ...
                Criteria weights must sum to 100% before proceeding. Currently{" "}
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-lg">
                    ...
                    <div className="space-y-4 text-sm text-muted-foreground">
                      ...
                      <ul className="space-y-2 list-disc list-inside">
                        <li>
                          <strong>Input format</strong>: exactly what the
                          program reads from stdin. One value per line for
                          multiple inputs.
                        </li>
                        <li>
                          <strong>Expected output</strong>: exact stdout
                          expected, including newlines. Trailing whitespace is
                          ignored during comparison.
                        </li>
                        <li>
                          <strong>Edge cases matter</strong>: include boundary
                          inputs (empty input, maximum values, invalid data).
                        </li>
                        <li>
                          <strong>Start with simple cases</strong>, then add
                          complexity. Test case #1 should validate basic
                          functionality.
                        </li>
                        <li>
                          Use the <em>Sample Answer</em> step to verify your
                          test cases are correct before publishing.
                        </li>
                      </ul>
                    </div>
                  </DialogContent>
              ...
              <div className="space-y-3">
                {testCases.map((tc) => (
                  <TestCaseBlock
                    ...
                    onChange={(updated) =>
                      updateTestCase(tc.test_case_id, updated)
                    }
          ...
          <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
            ...
            {testCases.length === 0 && (
              <p className="text-xs text-muted-foreground flex items-center gap-1.5 px-1">
                ...
                No test cases defined — add them in Step 4 to enable the run
                feature.
              </p>
            )}
                ...
                <div className="divide-y divide-border/40">
                  {testResults.map((r) => {
                    const tc = testCases.find(
                      (t) => t.test_case_id === r.test_case_id,
                    );
                    return (
                      <div
                        key={r.test_case_id}
        ...
        {currentStep === 6 && (
          <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
            ...
            {/* Assignment Details */}
            <ReviewCard title="Assignment Details" onEdit={() => setStep(1)}>
            ...
            <ReviewCard title="Assignment Settings" onEdit={() => setStep(2)}>
              ...
              <ReviewRow
                ...
                value={
                  settings.allow_late_submission ? "Allowed" : "Not allowed"
                }
              />
              <ReviewRow
                label="Time Limit"
              ...
              <ReviewRow
                ...
                value={
                  settings.group_submission ? "Enabled (up to 5)" : "Disabled"
                }
              />
              <ReviewRow
