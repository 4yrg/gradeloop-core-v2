...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // ShadCN base colors mapped to our design system
        ...
        // Extended neutral palette for our 12-step system
        neutral: {
          0: "hsl(var(--neutral-0))",
      ...
      keyframes: {
        ...
        "pulse-ai": {
          "0%, 100%": {
            "box-shadow": "0 0 0 0 hsl(var(--ai) / 0.4)"
          },
          "70%": {
            "box-shadow": "0 0 0 10px hsl(var(--ai) / 0)"
          },
        },
      },
      animation: {
      ...
      boxShadow: {
        ...
        "ai-glow": "0 0 20px hsl(var(--ai) / 0.3)",
