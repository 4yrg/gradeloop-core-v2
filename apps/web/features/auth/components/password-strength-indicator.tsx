    ...
    <div className={cn("space-y-4", className)}>
        ...
        {[...Array(4)].map((_, i) => (
          <div
            ...
            className={cn(
              ...
              i < metCount ? "bg-primary" : "bg-muted",
            )}
          />
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-4">
        {requirements.map((req, i) => (
          ...
          >
            {req.met ? (
              <div className="flex-shrink-0 w-4 h-4 rounded-full border border-primary/20 flex items-center justify-center bg-primary/10">
