    ...
    if (isSubmitted) {
        return (
            <div className="w-full text-center">
                <div className="mb-10">
                    <h2 className="text-3xl font-bold text-[#002333] mb-2">Check your email</h2>
                    <p className="text-slate-500">
                        We have sent a password reset link to <span className="font-semibold text-[#002333]">{form.getValues("email")}</span>.
                    </p>
                </div>
                <Link href="/login">
                    <Button variant="outline" className="w-full h-12 border-slate-200 text-[#002333]">
                        Back to Login
                    </Button>
                </Link>
            </div>
