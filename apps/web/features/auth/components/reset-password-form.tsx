...
export function ResetPasswordForm() {
    ...
    if (isSubmitted) {
        return (
            <div className="w-full text-center">
                ...
                <div className="mb-10">
                    <h2 className="text-3xl font-bold text-[#002333] mb-2">Password Reset</h2>
                    <p className="text-slate-500">
                        Your password has been successfully reset. You can now log in with your new password.
                    </p>
                </div>
                <Link href="/login">
                    <Button className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-semibold rounded-lg shadow-lg shadow-primary/20 transition-all">
                        Proceed to Login
                    </Button>
                </Link>
            </div>
    ...
    return (
        <div className="w-full">
            <div className="mb-10">
                <h2 className="text-3xl font-bold text-[#002333] mb-2">Set new password</h2>
                <p className="text-slate-500">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-[#002333]">New Password</FormLabel>
                                <FormControl>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel className="text-[#002333]">Confirm Password</FormLabel>
                                <FormControl>
                                    <Input
                                        type={showPassword ? "text" : "password"}
                                        placeholder="••••••••"
