...
export function AuthLayout({ children, className }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen w-full bg-background font-sans overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-primary dark:bg-background">
        <img
      ...
      <div className="fixed bottom-6 right-6">
        <button className="bg-primary text-primary-foreground p-4 rounded-full shadow-2xl hover:bg-primary/90 transition-all group flex items-center space-x-2">
